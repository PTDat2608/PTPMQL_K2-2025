...
namespace FirstWebMVC.Controllers
{
    public class DaiLyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaDaiLy,TenDaiLy,DiaChi,NguoiDaiDien,DienThoai,MaHTTP,MaHTPP,TenHTPP")] DaiLy daiLy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaDaiLy,TenDaiLy,DiaChi,NguoiDaiDien,DienThoai,MaHTTP,MaHTPP,TenHTPP")] DaiLy daiLy)
        {
            if (id != daiLy.MaHTPP)
            {
                return NotFound();
